...
from utils import MAX_PROT_LEN, MAX_SMILES_LEN
...
class TransformerEncoder(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.Regression_Output = nn.Sequential(
            nn.Linear(config.vocab_size*config.n_embd, config.n_embd),  # Option #3
    ...
    def forward_base(self, idx):
        ...
        x_max = torch.flatten(x1, start_dim=1)
        #------->
...
# mat1 and mat2 shapes cannot be multiplied (16x285696 and 649216x512)
